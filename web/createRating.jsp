...
%>
<h3 class="col-sm-offset-1">Create Rating...</h3>
<div class="container">
    <form class="form-horizontal" action="procNewRate.jsp" method="POST">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="overall">Overall Rating:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Overall Rating" name="overall" required>
            </div>
        </div>
